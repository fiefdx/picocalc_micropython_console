...
class PyShell(Shell):
    def __init__(self, display_size = (19, 9), cache_size = (-1, 50), history_length = 50, prompt_c = "\x00\x00\x00", scheduler = None, display_id = None, storage_id = None, history_file_path = "/.cache/.python_history"):
