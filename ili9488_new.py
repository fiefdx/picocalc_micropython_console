...
class Display(object):
    ...
    def __init__(self, spi, cs, dc, rst,
                 width=320, height=480, rotation=270):
        """Initialize OLED.
        Args:
...
#         self.write_cmd(self.FRMCTR2, 0x00, 0x3c)  # Frame rate ctrl
    ...
    def fill_hrect(self, x, y, w, h, color):
        ...
        if chunk_count:
#             first_byte = color >> 8
#             second_byte = color & 0x00FF
#             first_byte = (first_byte >> 4) | ((first_byte & 0x0F) << 4)
#             second_byte = (second_byte >> 4) | ((second_byte & 0x0F) << 4)
# #             color = first_byte << 8 | second_byte
#             color = second_byte << 8 | first_byte
#             color = 0b0001000000000000 # 0x0f08 # 0xf080 # 0x80f0 # 0x800f # 0xf008 # 0x00f8 # 0x0f80 # 0x08f0 # 0x8f00 # 0x008f
#             print(hex(color), color.to_bytes(2, 'big'))
